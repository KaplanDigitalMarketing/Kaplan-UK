        ...
        <nav id="mp-menu" class="mp-menu">
            <div class="mp-level">
                <ul class="audience-switcher">
                    <li class="individuals active"><a class="audience-switcher__link">Individuals</a></li>
                    <li class="businesses"><a class="audience-switcher__link">Businesses</a></li>
                </ul>
                ...
                <ul>
                    <li class="icon icon-arrow-right">
                        ...
                        <div class="mp-level">
                            <ul>
                                <li><a class="mp-back" href="#"><span>‹</span> back</a></li>
                            ...
                            <ul>
                                ...
                                <li class="icon icon-arrow-right">
                                    <div class="mp-level">
                                        <ul>
                                            <li><a class="mp-back" href="#"><span>‹</span> back</a></li>
                                            <li><a href="#">Accountancy and Tax Overview</a></li>
                                            <li><a href="#">AAT</a></li>
                                            <li><a href="#">ACCA</a></li>
                                ...
                                <li class="icon icon-arrow-right">
                                    ...
                                    <div class="mp-level">
                                        <ul>
                                            <li><a class="mp-back" href="#"><span>‹</span> back</a></li>
                                            <li><a href="#">Banking and Financial Services Overview</a></li>
                                            <li><a href="#">CAIA</a></li>
                    ...
                    <li class="icon icon-arrow-right">
                        ...
                        <div class="mp-level">
                            <ul>
                                <li><a class="mp-back" href="#"><span>‹</span> back</a></li>
                                <li><a href="#">Apprenticeships &amp; Internships Overview</a></li>
                    ...
                    <li class="icon icon-arrow-right">
                        ...
                        <div class="mp-level">
                            <ul>
                                <li><a class="mp-back" href="#"><span>‹</span> back</a></li>
                                <li><a href="#">About Kaplan Overview</a></li>
